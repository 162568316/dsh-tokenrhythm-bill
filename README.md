...
| | |
|---|---|
| **模型页签** —— 分类筛选 + 卡片网格 + 连通检测 | **余额主卡** —— 账户余额 + 限时额度占比 |
| ![模型页签](image/28837e2c7728737de8b199d0a8f8d15a.png) | ![余额主卡](image/72aa29abafe55994ea8e31951d6f12d3.png) |
| **设置页** —— 账号管理 + Cookie 兜底 | **侧栏入口** —— 品牌标按钮 + 预警点 |
| ![设置页](image/e12ac6893257ef09a29ce50c34946a0a.png) | ![侧栏入口](image/bf233356b4569c2763958ecbc0a74efe.png) |

## 功能一览

### 模型
- 顶部**分类筛选**：全部 / 文本 / 图像 / 音频 / 视频 / 向量（带计数，口径与平台模型列表页一致）；滚动时**吸附固定**，缓存命中时行尾显示缓存标签
