...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const PANEL_CSS = `
       ...
       * 并垫面板实色底，卡片列表从其下方滚过不透出。 */
      .dsh-mb-cats{position:sticky;top:0;z-index:2;display:flex;flex-wrap:wrap;gap:6px;
        margin:0 -14px;padding:4px 14px 6px;background:var(--mb-panelBg)}
