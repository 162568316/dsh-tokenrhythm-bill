...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const alertOf = (d) => {
      ...
      return { low, expiring, expDays, expiringBalanceCny: d.expiringBalanceCny, availableBalanceCny: d.availableBalanceCny, balanceCny: d.balanceCny }
    }
    ...
    function EntryButton(props) {
      ...
      const bCny = (s.alert && s.alert.balanceCny) != null ? s.alert.balanceCny : null
      const balText = bCny != null ? '¥' + fmtCny(bCny) : null
