...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function Panel() {
      ...
      return React.createElement('div', {
        ...
        React.createElement('div', { className: 'dsh-mb-body' },
          ...
          view === 'balance' ? renderBalanceTab({ manifest, balance, loadBalance, goSettings: toggleSettings, showCalls, setShowCalls, trendHoverIdx, setTrendHoverIdx }) : null,
    ...
    function renderBalanceTab({ manifest, balance, loadBalance, goSettings, showCalls, setShowCalls, trendHoverIdx, setTrendHoverIdx }) {
      const capable = manifest && Array.isArray(manifest.providers) && manifest.providers.some((p) => p.balanceCapable)
      if (!capable) {
    ...
    const PANEL_CSS = `
      ...
      .dsh-mb-entry-icon{position:relative;flex:none;display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;font-size:15px;font-weight:600}
